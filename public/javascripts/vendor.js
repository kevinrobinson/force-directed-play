    ...
    return module.exports = Layout = (function() {
      ...
      function Layout() {
        ...
        this.openLink = function(event) {
          return Layout.prototype.openLink.apply(_this, arguments);
        };
        this.initialize.apply(this, arguments);
      }
  ...
  'chaplin/views/collection_view': function(exports, require, module) {
    ...
    return module.exports = CollectionView = (function(_super) {
      ...
      function CollectionView(options) {
        var _this = this;
        this.renderAllItems = function() {
          return CollectionView.prototype.renderAllItems.apply(_this, arguments);
        };
        this.showHideFallback = function() {
          return CollectionView.prototype.showHideFallback.apply(_this, arguments);
        };
        this.itemsResetted = function() {
          return CollectionView.prototype.itemsResetted.apply(_this, arguments);
        };
        this.itemRemoved = function(item) {
          return CollectionView.prototype.itemRemoved.apply(_this, arguments);
        };
        this.itemAdded = function(item, collection, options) {
          if (options == null) {
            options = {};
          }
          return CollectionView.prototype.itemAdded.apply(_this, arguments);
        };
        if (options) {
  ...
  'chaplin/lib/route': function(exports, require, module) {
    ...
    return module.exports = Route = (function() {
      ...
      function Route(pattern, controller, action, options) {
        ...
        this.handler = function(path, options) {
          if (options == null) {
            options = {};
          }
          return Route.prototype.handler.apply(_this, arguments);
        };
        this.addParamName = function(match, paramName) {
          return Route.prototype.addParamName.apply(_this, arguments);
        };
  ...
  'chaplin/lib/router': function(exports, require, module) {
    ...
    return module.exports = Router = (function() {
      ...
      function Router(options) {
        var _this = this;
        this.options = options != null ? options : {};
        this.route = function(path, options) {
          if (options == null) {
            options = {};
          }
          return Router.prototype.route.apply(_this, arguments);
        };
        this.match = function(pattern, target, options) {
          if (options == null) {
            options = {};
          }
          return Router.prototype.match.apply(_this, arguments);
        };
